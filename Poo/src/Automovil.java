public class Automovil { //Una clase puede ser public o default (class nombre)
    ...
    //Constructor default.
    public Automovil() { //Así cada vez que se cree un nuevo objeto en el constructor se incrementara en 1 por cada invocación del constructor;
        this.id = ++ultimoId;
    }
    ...
    public Automovil(String fabricante, String modelo, Color color, double cilindrada, int capacidadEstanque) {
        this(fabricante, modelo, color, cilindrada);   //Sobrecarga de constructores
    ...
    public String verDetalle() { //Método de la clase automóvil
        ...
        return "auto.id = " + this.id +
                ...
                "\ncilindrada = " + this.cilindrada; //Se puede utilizar los get o directamente con this porque son de la misma clase.
    ...
    public boolean equals(Object obj) {
        ...
        if(!(obj instanceof Automovil)){ //Si el objeto no es instancia del tipo de objeto Automóvil, retorna falso y salimos.
            return false;
        }
